...
export default function BPJSIndex(props: Props) {
    const INITIAL = {
        search: '',
        kecamatan: '',
        hamlet: '',
    ...
    const { data, setData, get, processing, reset } = useForm<SearchParam>(INITIAL)
    ...
    React.useEffect(() => {
        const fetchTahun = async () => {
            const response = await axios.get('/bpjs-years')
                    ...
                    <div className="col-lg-12 col-md-12">
                        <div className="card planned_task">
                            ...
                            <div className="body table-responsive pt-0">
                                {props.applications.data.length < 1 ? <p className="mt-3">Belum ada data</p> : <table className="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Tanggal</th>
