        ...
        <Admin>
                ...
                footer={
                    <div className="d-flex">
                        ...
                        <Button className="btn btn-sm btn-danger" onClick={async () => {
                            await axios.delete(route('ward.destroy', id.current))
                            get(route('district.show', district.id), {
                                replace: true,
                                preserveState: false,
                                onSuccess: () => {
                                    modalHapus.close()
            ...
            <div className="container-fluid">
                <PageHeader
                    ...
                    Breadcrumb={[{ name: 'Kecamatan', navigate: 'district.index' }, { name: 'Kel - Des' }]}
                />
                    ...
                    <div className="col-xs-12 col-lg-12 col-md-12">
                        <div className="card planned_task">
                            ...
                            <div className="body table-responsive pt-0">
                                {
                                    wards.data.length == 0 ? <p>Tidak ada data</p>
                                        :
                                        <table className='table table-bordered'>
                                            ...
                                            <tbody>
                                                {wards.data.map((v, i) => {
                                                    return (
                                                        <tr key={i}>
                                                            <th>{((wards.current_page - 1) * (wards.per_page)) + i + 1}</th>
                                                            <td>{v.name}</td>
                                                            <td>
